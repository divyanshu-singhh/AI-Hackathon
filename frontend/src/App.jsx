    ...
    <main>
      ...
      <section className="workspace">
        <aside className="control-column">
          ...
          {tab === "single" ? <UploadPanel stages={stages} onResult={setSingleResult} /> : null}
          {tab === "multi" ? <BatchUploadPanel stages={stages} onBatch={handleBatch} /> : null}
          {tab === "csv" ? <GoogleSheetPanel stages={stages} onBatch={handleBatch} /> : null}
        </aside>
